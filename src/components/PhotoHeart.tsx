...
const PhotoHeart = () => {
  ...
  const desktopPhotos: Photo[] = [
    ...
    { id: 1, src: "/images/IMG_1785.jpg", alt: "Photo 1", style: { top: "8%", left: "25%", transform: "rotate(0deg)" } },
    { id: 2, src: "/images/IMG_1308.jpg", alt: "Photo 2", style: { top: "20%", left: "25%", transform: "rotate(0deg)" } },
    { id: 3, src: "/images/IMG_1289.jpg", alt: "Photo 3", style: { top: "32%", left: "25%", transform: "rotate(0deg)" } },
    { id: 4, src: "/images/IMG_1338.jpg", alt: "Photo 4", style: { top: "44%", left: "25%", transform: "rotate(0deg)" } },
    { id: 5, src: "/images/IMG_1230.jpg", alt: "Photo 5", style: { top: "56%", left: "25%", transform: "rotate(0deg)" } },
    { id: 7, src: "/images/IMG_1180.jpg", alt: "Photo 7", style: { top: "20%", left: "15%", transform: "rotate(0deg)" } },
    { id: 8, src: "/images/IMG_0932.jpg", alt: "Photo 8", style: { top: "32%", left: "15%", transform: "rotate(0deg)" } },
    { id: 9, src: "/images/IMG_0967.jpg", alt: "Photo 9", style: { top: "32%", left: "35%", transform: "rotate(0deg)" } },
    
    // Bottom to right curve (bottom to top)
    { id: 18, src: "/images/IMG_2263.jpg", alt: "Photo 18", style: { top: "56%", left: "35%", transform: "rotate(0deg)" } },
    { id: 17, src: "/images/IMG_2197.jpg", alt: "Photo 17", style: { top: "32%", left: "55%", transform: "rotate(0deg)" } },
    { id: 16, src: "/images/IMG_2016.jpg", alt: "Photo 16", style: { top: "20%", left: "55%", transform: "rotate(0deg)" } },
    { id: 14, src: "/images/IMG_Beach.jpg", alt: "Photo 14", style: { top: "56%", left: "45%", transform: "rotate(0deg)" } },
    { id: 13, src: "/images/IMG_Cafe.jpg", alt: "Photo 13", style: { top: "44%", left: "45%", transform: "rotate(0deg)" } },
    { id: 12, src: "/images/IMG_1262.jpg", alt: "Photo 12", style: { top: "32%", left: "45%", transform: "rotate(0deg)" } },
    { id: 11, src: "/images/IMG_2255.jpg", alt: "Photo 11", style: { top: "20%", left: "45%", transform: "rotate(0deg)" } },
    { id: 10, src: "/images/IMG_2255.jpg", alt: "Photo 10", style: { top: "8%", left: "45%", transform: "rotate(0deg)" } },
